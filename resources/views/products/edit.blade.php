                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="minimum_stock_alert"
                                        value="{{ $product->minimum_stock_alert }}" class="form-control" required>
                                </div>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="storage_requirements"
                                    value="{{ $product->storage_requirements }}" class="form-control">
                            </div>
                            <div class="form-check">
                                <input type="checkbox" name="prescription_required" value="1"
                                    class="form-check-input" {{ $product->prescription_required ? 'checked' : '' }}>
